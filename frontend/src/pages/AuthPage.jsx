...
export function LoginPage({ intendedRole = 'CUSTOMER', title = 'Customer login' }) {
  ...
  async function submit(event) {
    ...
    try {
      const user = await login(form.identifier, form.password, intendedRole);
